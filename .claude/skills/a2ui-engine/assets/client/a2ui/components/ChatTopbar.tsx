 ...
 *
 * Fixed topbar for the chat page. Shows the session title (or "A2UI Chat"),
...
/** The three panels available in the chat container. */
export type A2uiChatView = "chat" | "workflows" | "schemas";
...
interface ChatTopbarProps {
  ...
  onViewChange: (view: A2uiChatView) => void;
...
const TABS: { view: A2uiChatView; icon: React.ReactNode; label: string }[] = [
...
/**
 * Top bar for the chat page with an inline panel-switching tab toggle.
 *
