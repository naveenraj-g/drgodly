/**
 * ToolCallDetails.tsx — collapsible tool-call bubble for the chat message list.
 *
 * Layer: client / a2ui / components / chat
 *
 * Shows the name, status badge, submitted form data, and result of a single
 * A2UI form submission. Used inside MessageList when a ChatMessage has a
 * `toolCall` property.
 *
 * Copied into this module from a2ui/components so the chat feature is
 * self-contained and does not reach into the a2ui component layer.
 */
...
import type { ToolCallInfo } from "@/modules/client/a2ui/store/chat-store";

interface ToolCallDetailsProps {
  /** The tool call metadata to render. */
  toolCall: ToolCallInfo;
}

/**
 * Collapsible card that shows a single A2UI form submission with its status,
 * submitted data, and result.
 *
