/**
 * utils.ts — pure helper functions for the chat container.
 *
 * Layer: client / a2ui / components / chat
 *
 * No React hooks — these are plain utilities shared across the container,
 * its sub-hooks (useA2uiWorkflow, useA2uiSend, useA2uiDispatch), and sub-components.
 */

import type { AnyComponentNode, MarkdownNode } from "@/modules/client/a2ui/types";
