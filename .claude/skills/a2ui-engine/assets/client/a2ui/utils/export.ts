/**
 * export — download helpers for tables and charts.
 *
 * Layer: client / a2ui / utils
 *
 * Used by ExportDialog (../components/export-dialog.tsx), which every chart
 * catalog component and DataTable mounts as their "export" action. Table
 * exports (CSV/JSON/XLSX/PDF) take a flat column+row shape; chart exports
 * rasterize a DOM element (the chart's container ref) to an image.
 */
