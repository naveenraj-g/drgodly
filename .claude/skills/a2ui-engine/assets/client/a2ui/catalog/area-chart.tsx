...
import type { AreaChartNode } from "../types";
...
export function AreaChart({ processor, surfaceId, component, weight = "initial" }: Props) {
  ...
  const stacked = component.properties.stacked ?? false;
  const fillOpacity = component.properties.fillOpacity ?? 0.3;
