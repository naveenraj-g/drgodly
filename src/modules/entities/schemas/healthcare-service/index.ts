/**
 * HealthcareService schema barrel.
 *
 * Layer: entities / schemas / healthcare-service
 *
 * Single import point for all HealthcareService schemas and types. All other
 * modules import from this barrel — never from the sub-files directly.
 *
