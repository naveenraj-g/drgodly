...
/** Display labels for each row height value */
...
interface DataTableRowHeightProps {
  /** Currently active row height value */
  value: RowHeightValue;
  /**
   * Callback fired when the user selects a different height.
   * @param value - The newly selected RowHeightValue.
   */
