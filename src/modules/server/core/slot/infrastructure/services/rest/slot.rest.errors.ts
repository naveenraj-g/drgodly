/**
 * handleSlotApiError — Axios → domain error mapper for Slot REST services.
 *
...
/**
 * Maps an AxiosError from the fhir-gql Slot API to a typed domain error and throws it.
