/**
 * EMR Chat service interface.
 *
 * Layer: server / core / emr-chat / domain
 *
 * Defines the contract for all EMR chat persistence operations.
 * Implemented by EmrChatService (Prisma). Registered in the DI container
 * so usecases can resolve it via getInjection("IEmrChatService").
 */
 ...
 */
export interface IEmrChatService {
  // ── Sessions ──────────────────────────────────────────────────────────────
