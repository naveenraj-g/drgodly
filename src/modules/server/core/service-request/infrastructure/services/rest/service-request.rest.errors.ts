/**
 * handleServiceRequestApiError — Axios → domain error mapper for ServiceRequest REST services.
 *
...
/**
 * Maps an AxiosError from the fhir-gql ServiceRequest API to a typed domain error and throws it.
 ...
 */
export function handleServiceRequestApiError(error: AxiosError): never {
  handleFhirApiError(error, "ServiceRequest");
}
