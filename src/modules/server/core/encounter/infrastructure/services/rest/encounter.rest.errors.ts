/**
 * handleEncounterApiError — Axios → domain error mapper for Encounter REST services.
 *
...
/**
 * Maps an AxiosError from the fhir-gql Encounter API to a typed domain error and throws it.
 ...
 */
export function handleEncounterApiError(error: AxiosError): never {
  handleFhirApiError(error, "Encounter");
}
