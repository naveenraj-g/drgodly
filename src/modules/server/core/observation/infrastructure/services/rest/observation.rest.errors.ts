/**
 * handleObservationApiError — Axios → domain error mapper for Observation REST services.
 *
...
/**
 * Maps an AxiosError from the fhir-gql Observation API to a typed domain error and throws it.
...
export function handleObservationApiError(error: AxiosError): never {
  handleFhirApiError(error, "Observation");
}
