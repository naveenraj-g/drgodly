...
export async function patchPatientPhotoController(input: unknown): Promise<TPatchPatientPhotoControllerOutput> {
  ...
  return presenter(await patchPatientPhotoUseCase(patient_id, item_id, dto as any));
}
