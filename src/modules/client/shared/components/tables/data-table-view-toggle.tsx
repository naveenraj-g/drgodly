...
/**
 * Renders Table and Grid toggle buttons. The active button is filled/primary
 * while the inactive one uses a ghost style. Clicking either button calls
 * onViewChange with the selected mode.
 *
