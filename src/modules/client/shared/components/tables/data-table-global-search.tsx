...
interface DataTableGlobalSearchProps<TData>
  ...
  /** TanStack Table instance to set the global filter on */
  table: Table<TData>;
  /**
...
export function DataTableGlobalSearch<TData>({
  ...
  // Local controlled state for the input so UI stays responsive
  const [value, setValue] = React.useState(
    (table.getState().globalFilter as string) ?? "",
  );

  // Only apply to the table after the debounce delay
