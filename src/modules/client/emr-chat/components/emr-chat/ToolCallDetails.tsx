/**
 * ToolCallDetails.tsx — collapsible tool-call bubble for the EMR chat message list.
 *
 ...
 * self-contained and does not reach into the ai-hub component layer.
 */
...
import type { ToolCallInfo } from "@/modules/client/ai-hub/store/chat-store";
