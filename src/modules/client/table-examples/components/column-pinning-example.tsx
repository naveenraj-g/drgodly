...
const DEMO_PARTICIPANTS: TrialParticipant[] = [
  { id: "TR001", name: "Alice Monroe",      age: 42, gender: "Female", bloodType: "A+",  trialArm: "Treatment A", startDate: "2024-01-15", endDate: "2024-07-15", dosage: "50mg",  primaryEndpoint: "Met",     adverseEvents: 1, status: "completed"  },
  { id: "TR002", name: "Bernard Osei",      age: 58, gender: "Male",   bloodType: "O+",  trialArm: "Control",     startDate: "2024-01-20", endDate: "2024-07-20", dosage: "—",     primaryEndpoint: "Not Met", adverseEvents: 0, status: "completed"  },
  { id: "TR003", name: "Clara Nguyen",      age: 35, gender: "Female", bloodType: "B+",  trialArm: "Treatment B", startDate: "2024-02-01", endDate: "2024-08-01", dosage: "100mg", primaryEndpoint: "Met",     adverseEvents: 2, status: "completed"  },
  { id: "TR004", name: "Daniel Fischer",    age: 61, gender: "Male",   bloodType: "AB+", trialArm: "Treatment A", startDate: "2024-02-10", endDate: "2024-08-10", dosage: "50mg",  primaryEndpoint: "Pending", adverseEvents: 3, status: "active"     },
  { id: "TR005", name: "Elena Vasquez",     age: 29, gender: "Female", bloodType: "O-",  trialArm: "Treatment B", startDate: "2024-02-15", endDate: "2024-08-15", dosage: "100mg", primaryEndpoint: "Pending", adverseEvents: 0, status: "active"     },
  { id: "TR006", name: "Felix Andersen",    age: 47, gender: "Male",   bloodType: "A-",  trialArm: "Control",     startDate: "2024-03-01", endDate: "2024-09-01", dosage: "—",     primaryEndpoint: "Not Met", adverseEvents: 1, status: "active"     },
  { id: "TR007", name: "Grace Okafor",      age: 53, gender: "Female", bloodType: "B-",  trialArm: "Treatment A", startDate: "2024-03-10", endDate: "2024-09-10", dosage: "50mg",  primaryEndpoint: "Met",     adverseEvents: 0, status: "completed"  },
  { id: "TR008", name: "Hamid Rezaei",      age: 44, gender: "Male",   bloodType: "O+",  trialArm: "Treatment B", startDate: "2024-03-20", endDate: "2024-09-20", dosage: "100mg", primaryEndpoint: "Pending", adverseEvents: 4, status: "withdrawn"  },
  { id: "TR009", name: "Irene Petrov",      age: 38, gender: "Female", bloodType: "AB-", trialArm: "Control",     startDate: "2024-04-01", endDate: "2024-10-01", dosage: "—",     primaryEndpoint: "Pending", adverseEvents: 0, status: "active"     },
  { id: "TR010", name: "James Lim",         age: 66, gender: "Male",   bloodType: "A+",  trialArm: "Treatment A", startDate: "2024-04-10", endDate: "2024-10-10", dosage: "50mg",  primaryEndpoint: "Not Met", adverseEvents: 2, status: "active"     },
  { id: "TR011", name: "Kira Johansson",    age: 31, gender: "Female", bloodType: "O+",  trialArm: "Treatment B", startDate: "2024-04-15", endDate: "2024-10-15", dosage: "100mg", primaryEndpoint: "Pending", adverseEvents: 1, status: "screening"  },
  { id: "TR012", name: "Leo Castillo",      age: 55, gender: "Male",   bloodType: "B+",  trialArm: "Control",     startDate: "2024-05-01", endDate: "2024-11-01", dosage: "—",     primaryEndpoint: "Pending", adverseEvents: 0, status: "screening"  },
  { id: "TR013", name: "Maya Patel",        age: 40, gender: "Female", bloodType: "AB+", trialArm: "Treatment A", startDate: "2024-05-10", endDate: "2024-11-10", dosage: "50mg",  primaryEndpoint: "Met",     adverseEvents: 0, status: "active"     },
  { id: "TR014", name: "Nils Bergström",    age: 72, gender: "Male",   bloodType: "O-",  trialArm: "Treatment B", startDate: "2024-05-15", endDate: "2024-11-15", dosage: "100mg", primaryEndpoint: "Not Met", adverseEvents: 5, status: "withdrawn"  },
  { id: "TR015", name: "Olivia Ferreira",   age: 26, gender: "Female", bloodType: "A-",  trialArm: "Control",     startDate: "2024-06-01", endDate: "2024-12-01", dosage: "—",     primaryEndpoint: "Pending", adverseEvents: 0, status: "active"     },
  { id: "TR016", name: "Patrick Onyeka",    age: 49, gender: "Male",   bloodType: "B+",  trialArm: "Treatment A", startDate: "2024-06-10", endDate: "2024-12-10", dosage: "50mg",  primaryEndpoint: "Pending", adverseEvents: 1, status: "active"     },
  { id: "TR017", name: "Rina Kawamoto",     age: 37, gender: "Female", bloodType: "AB+", trialArm: "Treatment B", startDate: "2024-06-15", endDate: "2024-12-15", dosage: "100mg", primaryEndpoint: "Pending", adverseEvents: 2, status: "screening"  },
  { id: "TR018", name: "Stefan Müller",     age: 63, gender: "Male",   bloodType: "O+",  trialArm: "Control",     startDate: "2024-07-01", endDate: "2025-01-01", dosage: "—",     primaryEndpoint: "Pending", adverseEvents: 0, status: "active"     },
  { id: "TR019", name: "Talia Abramowitz",  age: 45, gender: "Female", bloodType: "A+",  trialArm: "Treatment A", startDate: "2024-07-10", endDate: "2025-01-10", dosage: "50mg",  primaryEndpoint: "Pending", adverseEvents: 3, status: "active"     },
  { id: "TR020", name: "Ugo Eze",           age: 57, gender: "Male",   bloodType: "B-",  trialArm: "Treatment B", startDate: "2024-07-15", endDate: "2025-01-15", dosage: "100mg", primaryEndpoint: "Met",     adverseEvents: 1, status: "completed"  },
];
...
const COLUMNS: ColumnDef<TrialParticipant>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <span className={`text-sm font-medium whitespace-nowrap ${ARM_COLORS[arm]}`}>
          {arm}
        </span>
      );
    },
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const ep = row.getValue("primaryEndpoint") as TrialParticipant["primaryEndpoint"];
      return (
        <Badge variant={ENDPOINT_VARIANT[ep]}>{ep}</Badge>
      );
    },
    enableSorting: true,
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <span className={count > 2 ? "font-semibold text-destructive" : "text-sm"}>
          {count}
        </span>
      );
    },
