/**
 * IdentifiersTab — FHIR business identifiers for the slot (e.g. booking
 * reference numbers).
 *
    ...
    <div className="flex flex-col gap-3 p-1 pr-3">
      <div className="flex items-center justify-between">
        <p className="text-sm text-muted-foreground">
          Business identifiers assigned to this slot.
        </p>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <Field>
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Input {...field} value={field.value ?? ""} placeholder="BOOK-104" />
                  )}
                />
              </Field>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <Field>
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Input {...field} value={field.value ?? ""} placeholder="http://hospital.org/bookings" />
                  )}
                />
              </Field>
              <Field>
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Input {...field} value={field.value ?? ""} placeholder="Front Desk" />
                  )}
                />
              </Field>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <Field>
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Input {...field} value={field.value ?? ""} placeholder="BOOK" />
                  )}
                />
              </Field>
              <Field>
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Input {...field} value={field.value ?? ""} placeholder="Booking Reference" />
                  )}
                />
              </Field>
            </div>
