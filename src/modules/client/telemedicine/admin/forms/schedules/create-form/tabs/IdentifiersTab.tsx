/**
 * IdentifiersTab — FHIR business identifiers for the schedule.
 *
    ...
    <div className="flex flex-col gap-3 p-1 pr-3">
      <div className="flex items-center justify-between">
        <p className="text-sm text-muted-foreground">
          Business identifiers assigned to this schedule.
        </p>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <Field>
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Input {...field} value={field.value ?? ""} placeholder="SCH-104" />
                  )}
                />
              </Field>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <Field>
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Input {...field} value={field.value ?? ""} placeholder="http://hospital.org/schedules" />
                  )}
                />
              </Field>
              <Field>
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Input {...field} value={field.value ?? ""} placeholder="Scheduling Dept" />
                  )}
                />
              </Field>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <Field>
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Input {...field} value={field.value ?? ""} placeholder="SCHED" />
                  )}
                />
              </Field>
              <Field>
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Input {...field} value={field.value ?? ""} placeholder="Schedule Reference" />
                  )}
                />
              </Field>
            </div>
