/**
 * NamesTab — HumanName entries for the practitioner.
 *
 * `use` is sourced live from the FHIR terminology server via TerminologySelect
 * (resource="Patient" field="name.use" — the same generic binding used
 * across every other resource's HumanName fields this session).
 * `given`/`prefix`/`suffix` are comma-separated strings; the modal splits
 * each before submit.
 */
  ...
  return (
    <div className="flex flex-col gap-3 p-1 pr-3">
      <div className="flex items-center justify-between">
        <p className="text-sm text-muted-foreground">Names for this practitioner.</p>
