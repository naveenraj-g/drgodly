/**
 * AddressesTab — Address entries for the practitioner.
 *
 * `use`/`type` reuse the generic `Patient`/`address.use`/`address.type`
 * bindings already proven across every other resource this session — no
 * dedicated Practitioner address form exists in the A2UI reference to
 * confirm against, but the generic Patient binding applies here too.
 */
  ...
  return (
    <div className="flex flex-col gap-3 p-1 pr-3">
      <div className="flex items-center justify-between">
        <p className="text-sm text-muted-foreground">Addresses for this practitioner.</p>
