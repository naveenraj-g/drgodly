/**
 * LanguagesTab (edit) — communication language preferences for the
 * practitioner. Same fields and bindings as the create form's LanguagesTab,
 * typed against the edit form schema — fhir-gql's `/full` PATCH endpoint
 * fully replaces this array.
 */
    ...
    <div className="flex flex-col gap-3 p-1 pr-3">
      <div className="flex items-center justify-between">
        <p className="text-sm text-muted-foreground">
          Languages this practitioner can communicate in. Saving replaces the entire list.
        </p>
