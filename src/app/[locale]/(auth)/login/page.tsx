 ...
 *
 * Flow:
 *  1. Generate a random `state` (CSRF protection) and `code_verifier` (PKCE).
 *  2. Persist both in localStorage for validation in the /callback page.
 *  3. Redirect the browser to the IAM authorization endpoint.
 */
"use client";
